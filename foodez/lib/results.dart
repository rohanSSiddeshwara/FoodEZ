...
class food_results extends StatelessWidget {
  ...
  List<food_details> get_foods(String f_t ,{String c=''}) {
    ...
    return MaterialApp(
      home: Scaffold(
          floatingActionButton: FloatingActionButton(
            ...
            backgroundColor: Color.fromRGBO(248, 74, 12, 1),
          ),
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(
                      ...
                      child: GridView.count(
                          scrollDirection: Axis.vertical,
                          crossAxisCount: 2,
                          children: get_foods(this.food_type,c:this.cafe)
                              .map((e) => CardsFood(e))
                              .toList()),
                    ),
                  ],
                    ...
                    child: Column(children: [
                      Container(
                          ...
                          child: CircleAvatar(
                            ...
                            backgroundColor: Colors.white,
                            backgroundImage:
                                AssetImage('images/Image$image_num.png'),
                          ))),
                      Container(
