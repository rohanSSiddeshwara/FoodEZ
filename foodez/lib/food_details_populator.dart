...
class cart_food_details{
  ...
  int quantity;
  double total_price;
  cart_food_details({required this.food_name,required this.price,required this.quantity,required this.total_price,required this.image_num});
}

final List<String> payment_status=["Paid","Processing"];
final List<String> order_status=["Placed","Processing","Recived","Cancelled"];
class Orders{
  final String f_name;
  final double price;
  final int quantity;
  ...
  Orders({required this.f_name,required this.price,required this.quantity,required this.payment_Status,required this.order_Status,required this.canteen_Name,required this.image_num});
