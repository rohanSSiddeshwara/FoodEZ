...
class food extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Function add_to_cart=(food_details food){add_to_cart_foods(food,1);};
